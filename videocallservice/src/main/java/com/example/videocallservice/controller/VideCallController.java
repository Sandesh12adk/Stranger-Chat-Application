package com.example.videocallservice.controller;

import com.example.videocallservice.dto.SignalMessage;
...
@Controller
public class VideCallController {
    private final SimpMessagingTemplate messagingTemplate;
    private final PairingService pairingService;

    public VideCallController(SimpMessagingTemplate messagingTemplate,
    ...
    @MessageMapping("/signalmessage.send")
    public void sendMessage(@Payload SignalMessage singalMessage) {
        String receiverTopic = "/content/user/" + singalMessage.getTo();
        // Send to receiver only
        messagingTemplate.convertAndSend(receiverTopic,singalMessage);
    }
    @GetMapping("/health")
